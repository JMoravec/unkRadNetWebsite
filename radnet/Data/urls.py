...
urlpatterns = \
    patterns('',
             ...
             url(r'^ViewData/(?P<filter_id>\d+)/$', views.viewData,
                 name='viewData'),
             ...
             url(r'^AddRawData/CheckData/$', views.checkData,
                 name='checkData'),
             url(r'^AddRawData/CheckData/(?P<filter_id>\d+)/$',
                 views.checkData, name='checkData'),
