...
class Filter(models.Model):
    ...
    def __unicode__(self):
        return str(self.filterNum) + ': ' + str(self.startDate) + ' - ' + \
            str(self.endDate)
...
class Activity(models.Model):
    ...
    def fillData(self):
        ...
        self.netAlBet = self.RawData.betaReading - self.RawData.\
            cleanFilterCount
        self.netBeta = self.netAlBet - self.RawData.alphaReading
        self.alphaAct = self.RawData.alphaReading * self.Filter.alphaCoeff.\
            coefficient
